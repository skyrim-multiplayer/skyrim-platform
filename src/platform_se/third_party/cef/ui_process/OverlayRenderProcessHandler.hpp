...
struct OverlayRenderProcessHandler : CefRenderProcessHandler
{
  ...
  OverlayRenderProcessHandler& operator=(const OverlayRenderProcessHandler&) =
    delete;
  OverlayRenderProcessHandler& operator=(OverlayRenderProcessHandler&&) =
    delete;
...
protected:
  static CefRefPtr<CefV8Value> ConvertValue(
