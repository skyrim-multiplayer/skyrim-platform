#include "SKOverrideInterface.h"
#include "skse64/PapyrusVM.h"
#include "skse64/PluginAPI.h"

#include "SKNifUtils.h"
#include "SKOverrideVariant.h"
#include "SKShaderUtilities.h"
...
void OverrideInterface::AddRawOverride(UInt64 handle, bool isFemale,
                                       UInt64 armorHandle, UInt64 addonHandle,
                                       BSFixedString nodeName,
                                       OverrideVariant& value)
{
  armorData.Lock();
  armorData
    .m_data[handle][isFemale ? 1 : 0][armorHandle][addonHandle]
           [g_stringTable.GetString(nodeName)]
    .erase(value);
  armorData
    .m_data[handle][isFemale ? 1 : 0][armorHandle][addonHandle]
           [g_stringTable.GetString(nodeName)]
...
void OverrideInterface::AddOverride(TESObjectREFR* refr, bool isFemale,
...
void OverrideInterface::AddRawNodeOverride(UInt64 handle, bool isFemale,
                                           BSFixedString nodeName,
                                           OverrideVariant& value)
{
  nodeData.Lock();
  nodeData.m_data[handle][isFemale ? 1 : 0][g_stringTable.GetString(nodeName)]
    .erase(value);
  nodeData.m_data[handle][isFemale ? 1 : 0][g_stringTable.GetString(nodeName)]
    .insert(value);
  nodeData.Release();
...
void OverrideInterface::AddNodeOverride(TESObjectREFR* refr, bool isFemale,
                                        BSFixedString nodeName,
                                        OverrideVariant& value)
{
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
...
void OverrideInterface::AddRawWeaponOverride(UInt64 handle, bool isFemale,
                                             bool firstPerson,
                                             UInt64 weaponHandle,
                                             BSFixedString nodeName,
                                             OverrideVariant& value)
{
  weaponData.Lock();
  weaponData
    .m_data[handle][isFemale ? 1 : 0][firstPerson ? 1 : 0][weaponHandle]
           [g_stringTable.GetString(nodeName)]
    .erase(value);
  weaponData
    .m_data[handle][isFemale ? 1 : 0][firstPerson ? 1 : 0][weaponHandle]
...
void OverrideInterface::AddWeaponOverride(TESObjectREFR* refr, bool isFemale,
                                          bool firstPerson,
...
void OverrideInterface::AddRawSkinOverride(UInt64 handle, bool isFemale,
                                           bool firstPerson, UInt32 slotMask,
                                           OverrideVariant& value)
{
  skinData.Lock();
  skinData.m_data[handle][isFemale ? 1 : 0][firstPerson ? 1 : 0][slotMask]
    .erase(value);
  skinData.m_data[handle][isFemale ? 1 : 0][firstPerson ? 1 : 0][slotMask]
    .insert(value);
  skinData.Release();
...
void OverrideInterface::AddSkinOverride(TESObjectREFR* refr, bool isFemale,
                                        bool firstPerson, UInt32 slotMask,
                                        OverrideVariant& value)
{
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
...
OverrideVariant* OverrideInterface::GetOverride(
  TESObjectREFR* refr, bool isFemale, TESObjectARMO* armor,
  TESObjectARMA* addon, BSFixedString nodeName, UInt16 key, UInt8 index)
{
...
OverrideVariant* OverrideInterface::GetNodeOverride(TESObjectREFR* refr,
                                                    bool isFemale,
                                                    BSFixedString nodeName,
                                                    UInt16 key, UInt8 index)
{
  UInt8 gender = isFemale ? 1 : 0;
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
...
OverrideVariant* OverrideInterface::GetWeaponOverride(
  TESObjectREFR* refr, bool isFemale, bool firstPerson, TESObjectWEAP* weapon,
  BSFixedString nodeName, UInt16 key, UInt8 index)
{
  UInt8 gender = isFemale ? 1 : 0;
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
...
OverrideVariant* OverrideInterface::GetSkinOverride(TESObjectREFR* refr,
                                                    bool isFemale,
                                                    bool firstPerson,
                                                    UInt32 slotMask,
                                                    UInt16 key, UInt8 index)
...
void OverrideInterface::RemoveAllArmorOverrides(TESObjectREFR* refr,
                                                bool isFemale,
                                                TESObjectARMO* armor)
{
  UInt8 gender = isFemale ? 1 : 0;
...
void OverrideInterface::RemoveAllArmorAddonOverrides(TESObjectREFR* refr,
                                                     bool isFemale,
                                                     TESObjectARMO* armor,
                                                     TESObjectARMA* addon)
{
...
void OverrideInterface::RemoveAllArmorAddonNodeOverrides(
  TESObjectREFR* refr, bool isFemale, TESObjectARMO* armor,
  TESObjectARMA* addon, BSFixedString nodeName)
{
  UInt8 gender = isFemale ? 1 : 0;
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
  SimpleLocker locker(&armorData.m_lock);
...
void OverrideInterface::RemoveArmorAddonOverride(
  TESObjectREFR* refr, bool isFemale, TESObjectARMO* armor,
  TESObjectARMA* addon, BSFixedString nodeName, UInt16 key, UInt8 index)
{
  UInt8 gender = isFemale ? 1 : 0;
...
void OverrideInterface::RemoveAllNodeNameOverrides(TESObjectREFR* refr,
                                                   bool isFemale,
                                                   BSFixedString nodeName)
{
  UInt8 gender = isFemale ? 1 : 0;
...
void OverrideInterface::RemoveNodeOverride(TESObjectREFR* refr, bool isFemale,
                                           BSFixedString nodeName, UInt16 key,
                                           UInt8 index)
{
  UInt8 gender = isFemale ? 1 : 0;
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
...
void OverrideInterface::RemoveAllWeaponOverrides(TESObjectREFR* refr,
                                                 bool isFemale,
                                                 bool firstPerson,
                                                 TESObjectWEAP* weapon)
{
  ...
  if (it != weaponData.m_data.end()) {
    UInt64 weaponHandle = VirtualMachine::GetHandle(weapon, weapon->formType);
    WeaponRegistration::iterator ait =
      it->second[gender][firstPerson ? 1 : 0].find(weaponHandle);
...
void OverrideInterface::RemoveAllWeaponNodeOverrides(TESObjectREFR* refr,
                                                     bool isFemale,
                                                     bool firstPerson,
                                                     TESObjectWEAP* weapon,
                                                     BSFixedString nodeName)
{
  ...
  if (it != weaponData.m_data.end()) {
    UInt64 weaponHandle = VirtualMachine::GetHandle(weapon, weapon->formType);
    WeaponRegistration::iterator ait =
      it->second[gender][fPerson].find(weaponHandle);
    if (ait != it->second[gender][firstPerson].end()) {
      OverrideRegistration<StringTableItem>::iterator oit =
        ait->second.find(g_stringTable.GetString(nodeName));
      if (oit != ait->second.end()) {
...
void OverrideInterface::RemoveWeaponOverride(TESObjectREFR* refr,
                                             bool isFemale, bool firstPerson,
                                             TESObjectWEAP* weapon,
                                             BSFixedString nodeName,
                                             UInt16 key, UInt8 index)
{
...
void OverrideInterface::RemoveAllSkinOverrides(TESObjectREFR* refr,
                                               bool isFemale, bool firstPerson,
                                               UInt32 slotMask)
{
  UInt8 gender = isFemale ? 1 : 0;
...
void OverrideInterface::RemoveSkinOverride(TESObjectREFR* refr, bool isFemale,
                                           bool firstPerson, UInt32 slotMask,
                                           UInt16 key, UInt8 index)
{
  UInt8 gender = isFemale ? 1 : 0;
...
void OverrideInterface::SetArmorAddonProperty(
  TESObjectREFR* refr, bool isFemale, TESObjectARMO* armor,
  TESObjectARMA* addon, BSFixedString nodeName, OverrideVariant* value,
  bool immediate)
{
  ...
  if (actor) {
    VisitArmorAddon(
      actor, armor, addon,
      [&](bool isFP, NiNode* rootNode, NiAVObject* armorNode) {
        bool isRoot = nodeName == BSFixedString("");
        if (!armorNode->GetAsNiNode() && !isRoot) {
          _WARNING("%s - Warning, override for Armor %08X Addon %08X has no "
                   "children, use an empty string for the node name to access "
                   "the root instead.",
                   __FUNCTION__, armor->formID, addon->formID);
        }
        NiAVObject* foundNode =
          isRoot ? armorNode : armorNode->GetObjectByName(&nodeName.data);
        if (foundNode) {
...
void OverrideInterface::GetArmorAddonProperty(
  TESObjectREFR* refr, bool firstPerson, TESObjectARMO* armor,
  TESObjectARMA* addon, BSFixedString nodeName, OverrideVariant* value)
{
  Actor* actor = DYNAMIC_CAST(refr, TESObjectREFR, Actor);
  if (actor) {
    VisitArmorAddon(actor, armor, addon,
                    [&](bool isFP, NiNode* rootNode, NiAVObject* armorNode) {
                      if (firstPerson == isFP) {
                        NiAVObject* foundNode = nodeName == BSFixedString("")
                          ? armorNode
                          : armorNode->GetObjectByName(&nodeName.data);
                        if (foundNode) {
...
bool OverrideInterface::HasArmorAddonNode(TESObjectREFR* refr,
                                          bool firstPerson,
                                          TESObjectARMO* armor,
                                          TESObjectARMA* addon,
                                          BSFixedString nodeName, bool debug)
{
  if (!refr) {
    if (debug)
    ...
    VisitArmorAddon(
      ...
      [&](bool isFP, NiNode* rootNode, NiAVObject* armorNode) {
        if (firstPerson == isFP) {
          ...
          if (foundNode) {
            if (debug)
              _DMESSAGE("%s - Success, found node name '%s' for Armor %08X, "
                        "Addon %08X.",
                        __FUNCTION__, nodeName.data, armor->formID,
                        addon->formID);

            found = true;
          } else if (debug)
            _DMESSAGE(
              "%s - Failed to find node name '%s' for Armor %08X, Addon %08X.",
              __FUNCTION__, nodeName.data, armor->formID, addon->formID);
        }
      });
  }
...
void OverrideInterface::SetWeaponProperty(
  TESObjectREFR* refr, bool isFemale, bool firstPerson, TESObjectWEAP* weapon,
  BSFixedString nodeName, OverrideVariant* value, bool immediate)
{
  ...
  NiNode* root = refr->GetNiRootNode(
    firstPerson ? 1 : 0); // Apply to third and first person
  if (root) {
    root->IncRef();
    BSFixedString weaponName(
      weaponString); // Find the Armor name from the root
    NiAVObject* weaponNode = root->GetObjectByName(&weaponName.data);
    if (weaponNode) {
      bool isRoot = nodeName == BSFixedString("");
      if (!weaponNode->GetAsNiNode() && !isRoot) {
        _WARNING(
          "%s - Warning, override for Weapon %08X has no children, use an "
          "empty string for the node name to access the root instead.",
          __FUNCTION__, weapon->formID);
      }
      NiAVObject* foundNode =
        isRoot ? weaponNode : weaponNode->GetObjectByName(&nodeName.data);
      if (foundNode) {
        SetShaderProperty(foundNode, value, immediate);
      }
    }
...
void OverrideInterface::GetWeaponProperty(TESObjectREFR* refr,
                                          bool firstPerson,
                                          TESObjectWEAP* weapon,
                                          BSFixedString nodeName,
                                          OverrideVariant* value)
{
  ...
  if (root) {
    ...
    if (weaponNode) {
      NiAVObject* foundNode = nodeName == BSFixedString("")
        ? weaponNode
        : weaponNode->GetObjectByName(&nodeName.data);
      if (foundNode) {
        GetShaderProperty(foundNode, value);
      }
    }
...
bool OverrideInterface::HasWeaponNode(TESObjectREFR* refr, bool firstPerson,
                                      TESObjectWEAP* weapon,
                                      BSFixedString nodeName, bool debug)
{
  if (!refr) {
  ...
  if (root) {
    ...
    if (weaponNode) {
      ...
      if (foundNode) {
        if (debug)
          _DMESSAGE("%s - Success, found node name '%s' for Weapon %08X.",
                    __FUNCTION__, nodeName.data, weapon->formID);
        return true;
      } else if (debug)
        _DMESSAGE("%s - Failed to find node name '%s' for Weapon %08X.",
                  __FUNCTION__, nodeName.data, weapon->formID);
    } else if (debug)
      _DMESSAGE("%s - Failed to acquire weapon node '%s' for Weapon %08X.",
                __FUNCTION__, weaponName.data, weapon->formID);
    root->DecRef();
  } else if (debug)
    _DMESSAGE("%s - Failed to acquire skeleton for Reference %08X",
              __FUNCTION__, refr->formID);

  return false;
}

void OverrideInterface::SetSkinProperty(TESObjectREFR* refr, bool isFemale,
                                        bool firstPerson, UInt32 slotMask,
                                        OverrideVariant* value, bool immediate)
{
  Actor* actor = DYNAMIC_CAST(refr, TESObjectREFR, Actor);
  if (actor) {
              ...
              if (firstPerson == isFP) {
                VisitObjects(armorNode, [&](NiAVObject* object) {
                  ...
                  if (geometry) {
                    ...
                    if (shaderProperty &&
                        ni_is_type(shaderProperty->GetRTTI(),
                                   BSLightingShaderProperty)) {
                      BSLightingShaderMaterial* material =
                        (BSLightingShaderMaterial*)shaderProperty->material;
                      if (material &&
                          material->GetShaderType() ==
...
void OverrideInterface::GetSkinProperty(TESObjectREFR* refr, bool firstPerson,
                                        UInt32 slotMask,
                                        OverrideVariant* value)
{
  Actor* actor = DYNAMIC_CAST(refr, TESObjectREFR, Actor);
...
{
  TESObjectREFR* refr =
    (TESObjectREFR*)VirtualMachine::GetObject(handle, TESObjectREFR::kTypeID);
  if (!refr) {
    return;
  }
  ...
  if (it != armorData.m_data.end()) {
    for (ArmorRegistration::iterator ait = it->second[gender].begin();
         ait != it->second[gender].end(); ++ait) // Loop Armors
    {
      TESObjectARMO* armor = (TESObjectARMO*)VirtualMachine::GetObject(
        ait->first, TESObjectARMO::kTypeID);
      if (!armor)
        continue;

      for (AddonRegistration::iterator dit = ait->second.begin();
           dit != ait->second.end(); ++dit) // Loop Addons
      {
        TESObjectARMA* addon = (TESObjectARMA*)VirtualMachine::GetObject(
          dit->first, TESObjectARMA::kTypeID);
        if (!addon)
          continue;
        ...
        VisitArmorAddon(
          ...
          [&](bool isFP, NiNode* rootNode, NiAVObject* armorNode) {
            dit->second.Visit(
              [&](const StringTableItem& key, OverrideSet* set) {
...
void OverrideInterface::SetNodeProperty(TESObjectREFR* refr,
                                        BSFixedString nodeName,
                                        OverrideVariant* value, bool immediate)
{
...
void OverrideInterface::GetNodeProperty(TESObjectREFR* refr, bool firstPerson,
                                        BSFixedString nodeName,
                                        OverrideVariant* value)
{
  NiNode* root = refr->GetNiRootNode(
...
void OverrideInterface::SetHandleNodeProperties(UInt64 handle, bool immediate)
{
  ...
  if (nit != nodeData.m_data.end()) {
    ...
    for (UInt8 i = 0; i <= 1; i++) {
      ...
      if (root) {
        root->IncRef();
        nit->second[gender].Visit(
          [&](const StringTableItem& key, OverrideSet* set) {
            BSFixedString nodeName(key->c_str());
            NiAVObject* foundNode = nodeName == BSFixedString("")
              ? root
              : root->GetObjectByName(&nodeName.data);
            if (foundNode) {
              set->Visit([&](OverrideVariant* value) {
                SetShaderProperty(foundNode, value, immediate);
                return false;
...
void OverrideInterface::SetHandleWeaponProperties(UInt64 handle,
                                                  bool immediate)
{
  TESObjectREFR* refr =
    (TESObjectREFR*)VirtualMachine::GetObject(handle, TESObjectREFR::kTypeID);
  ...
  if (it != weaponData.m_data.end()) {
    for (UInt8 i = 0; i <= 1; i++) {
      for (WeaponRegistration::iterator ait = it->second[gender][i].begin();
           ait != it->second[gender][i].end(); ++ait) // Loop Armors
      {
        TESObjectWEAP* weapon = (TESObjectWEAP*)VirtualMachine::GetObject(
          ait->first, TESObjectWEAP::kTypeID);
        if (!weapon)
          continue;
...
void OverrideInterface::SetHandleSkinProperties(UInt64 handle, bool immediate)
{
  ...
  if (it != skinData.m_data.end()) {
    for (UInt8 fp = 0; fp <= 1; fp++) {
      for (SkinRegistration::iterator ait = it->second[gender][fp].begin();
           ait != it->second[gender][fp].end(); ++ait) // Loop Armors
      {
        NiNode* lastNode = NULL;
          ...
          if (armor) {
            for (UInt32 i = 0; i < armor->armorAddons.count; i++) {
              ...
              if (armor->armorAddons.GetNthItem(i, arma)) {
                VisitArmorAddon(
                  actor, armor, arma,
                  [&](bool isFirstPerson, NiAVObject* rootNode,
                      NiAVObject* parent) {
                    if ((fp == 0 && isFirstPerson) ||
                        (fp == 1 && !isFirstPerson)) {
                      VisitObjects(parent, [&](NiAVObject* object) {
                        BSGeometry* geometry = object->GetAsBSGeometry();
                        if (geometry) {
                          BSShaderProperty* shaderProperty =
                            niptr_cast<BSShaderProperty>(
...
void OverrideInterface::VisitNodes(
  TESObjectREFR* refr,
  std::function<void(SKEEFixedString, OverrideVariant&)> functor)
{
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
...
void OverrideInterface::VisitSkin(
  TESObjectREFR* refr, bool isFemale, bool firstPerson,
  std::function<void(UInt32, OverrideVariant&)> functor)
{
  UInt64 handle = VirtualMachine::GetHandle(refr, refr->formType);
...
/*
void OverrideInterface::SetHandleArmorAddonProperties(UInt64 handle, UInt64
armorHandle, UInt64 addonHandle, bool immediate)
{
        TESObjectREFR * refr = (TESObjectREFR
*)VirtualMachine::GetObject(handle, TESObjectREFR::kTypeID); if(!refr) {
                armorData.Lock();
                armorData.m_data.erase(handle);
                armorData.Release();
                _MESSAGE("Error applying override: No such reference %016llX",
handle); return;
        }
        ...
        ActorRegistrationMapHolder::RegMap::iterator it =
armorData.m_data.find(handle); // Find ActorHandle if(it !=
armorData.m_data.end())
        {
                TESObjectARMO * armor = (TESObjectARMO
*)VirtualMachine::GetObject(armorHandle, TESObjectARMO::kTypeID); if(!armor) {
                        armorData.Lock();
                        armorData.m_data[handle][gender].erase(armorHandle);
                        armorData.Release();
                        _MESSAGE("Error applying override: No such armor
%016llX", armorHandle); return;
                }
                ArmorRegistration::iterator ait =
it->second[gender].find(armorHandle); // Find ArmorHandle if(ait !=
it->second[gender].end())
                {
                        TESObjectARMA * addon = (TESObjectARMA
*)VirtualMachine::GetObject(addonHandle, TESObjectARMA::kTypeID); if(!addon) {
                                armorData.Lock();
                                armorData.m_data[handle][gender][armorHandle].erase(addonHandle);
                                armorData.Release();
                                _MESSAGE("Error applying override: No such
addon %016llX", addonHandle); return;
                        }

                        AddonRegistration::iterator dit =
ait->second.find(addonHandle); // Find AddonHandle if(dit != ait->second.end())
                        {
                                char addonString[MAX_PATH];
                                addon->GetNodeName(addonString, refr, armor,
-1);
                                ...
                                {
                                        NiNode * root = refr->GetNiRootNode(i);
                                        if(root == lastRoot) // First and third
are the same, skip continue;

                                        if(root)
                                        {
                                                NiAVObject * armorNode =
root->GetObjectByName(&addonName.data); if(armorNode) {
                                                        OverrideRegistration<BSFixedString>::SetVisitor
visitor(armorNode, immediate); dit->second.Visit(&visitor);
                                                }
                                        }
...
{
public:
  NodeOverrideApplicator::NodeOverrideApplicator(
    OverrideRegistration<StringTableItem>* overrides, bool immediate)
...
public:
  ...
  void Apply()
  {
    for (auto& geometry : m_geometryList) {
      SKEEFixedString objectName(
        m_geometryList.size() == 1 ? "" : geometry->m_name);
...
{
public:
  SkinOverrideApplicator::SkinOverrideApplicator(TESObjectARMO* armor,
                                                 TESObjectARMA* addon,
                                                 UInt32 slotMask,
  ...
  virtual bool Accept(BSGeometry* geometry)
  {
    ...
    if ((armorMask & m_slotMask) == m_slotMask &&
        (addonMask & m_slotMask) == m_slotMask) {
      m_geometryList.push_back(geometry);
    }
  ...
  void Apply()
  {
    for (auto& geometry : m_geometryList) {
      BSShaderProperty* shaderProperty =
        niptr_cast<BSShaderProperty>(geometry->m_spEffectState);
      if (shaderProperty &&
          ni_is_type(shaderProperty->GetRTTI(), BSLightingShaderProperty)) {
        BSLightingShaderMaterial* material =
          (BSLightingShaderMaterial*)shaderProperty->material;
        if (material &&
            material->GetShaderType() ==
              BSLightingShaderMaterial::kShaderType_FaceGenRGBTint) {
          if (m_overrides) {
...
niNode->m_children.m_data) { for(int i = 0; i <
niNode->m_children.m_emptyRunStart; i++)
                        {
                                NiAVObject * object =
niNode->m_children.m_data[i]; if(object) GetGeometryCount(object, count);
                        }
                }
        }
}
...
template<>
void OverrideInterface::SetOverrides(NiGeometry * geometry,
OverrideRegistration<BSFixedString> * overrides, bool immediate, SInt32
geoCount)
{
        BSFixedString objectName(geoCount == 1 ? "" : geometry->m_name);
        OverrideRegistration<BSFixedString>::iterator nit =
overrides->find(objectName); if(nit != overrides->end())
        {
...
template<typename T>
void OverrideInterface::SetOverridesRecursive(NiAVObject * node,
OverrideRegistration<T> * overrides, bool immediate, SInt32 geoCount)
{
        ...
        else if(niNode && niNode->m_children.m_emptyRunStart > 0)
        {
                for(int i = 0; i < niNode->m_children.m_emptyRunStart; i++)
                {
                        ...
                        if(object)
                                SetOverridesRecursive(object, overrides,
immediate, geoCount);
                }
        }
}
...
void OverrideInterface::ApplyNodeOverrides(TESObjectREFR* refr,
                                           NiAVObject* object, bool immediate)
{
  UInt8 gender = 0;
  TESNPC* actorBase = DYNAMIC_CAST(refr->baseForm, TESForm, TESNPC);
  if (actorBase)
...
void OverrideInterface::ApplyOverrides(TESObjectREFR* refr,
                                       TESObjectARMO* armor,
                                       TESObjectARMA* addon,
                                       NiAVObject* object, bool immediate)
{
...
void OverrideInterface::ApplyWeaponOverrides(TESObjectREFR* refr,
                                             bool firstPerson,
                                             TESObjectWEAP* weapon,
                                             NiAVObject* object,
                                             bool immediate)
{
  ...
  if (it != weaponData.m_data.end()) {
    UInt64 weaponHandle = VirtualMachine::GetHandle(weapon, weapon->formType);
    auto ait = it->second[gender][firstPerson ? 1 : 0].find(
      weaponHandle); // Find WeaponHandle
    if (ait != it->second[gender][firstPerson ? 1 : 0].end()) {
...
void OverrideInterface::ApplySkinOverrides(
  TESObjectREFR* refr, bool firstPerson, TESObjectARMO* armor,
  TESObjectARMA* addon, UInt32 slotMask, NiAVObject* object, bool immediate)
{
  UInt8 gender = 0;
  TESNPC* actorBase = DYNAMIC_CAST(refr->baseForm, TESForm, TESNPC);
  if (actorBase)
  ...
  if (it != skinData.m_data.end()) {
    auto ait = it->second[gender][firstPerson ? 1 : 0].find(
      slotMask); // Find WeaponHandle
    if (ait != it->second[gender][firstPerson ? 1 : 0].end()) {
      SkinOverrideApplicator applicator(armor, addon, slotMask, &ait->second,
                                        immediate);
      VisitGeometry(object, &applicator);
      applicator.Apply();
    }
...
template <typename T>
void OverrideRegistration<T>::Visit(
  std::function<bool(const T& key, OverrideSet* set)> functor)
{
  for (auto it = begin(); it != end(); ++it) {
                           ...
                           const StringIdMap& stringTable)
{
  ...
  if (intfc->GetNextRecordInfo(&type, &version, &length)) {
    switch (type) {
        ...
        switch (this->type) {
          ...
          case kType_Identifier: {
            ...
            if (!intfc->ReadRecordData(&handle, sizeof(handle))) {
              _ERROR("%s - Error loading override value key handle",
                     __FUNCTION__);
              error = true;
              return error;
            }
            ...
            if (intfc->ResolveHandle(handle, &newHandle)) {
              ...
              if (policy->IsType(BGSTextureSet::kTypeID, newHandle))
                data.p =
                  (void*)policy->Resolve(BGSTextureSet::kTypeID, newHandle);
              else
                SetNone();
            } else
              SetNone();
      ...
      default: {
        _ERROR("%s - Error loading unexpected chunk type %08X (%.4s)",
...
void OverrideInterface::VisitStrings(
  std::function<void(SKEEFixedString)> functor)
{
                       ...
                       const StringIdMap& stringTable)
{
  ...
  if (intfc->GetNextRecordInfo(&type, &version, &length)) {
    switch (type) {
        ...
        for (UInt32 i = 0; i < numOverrides; i++) {
          ...
          if (!value.Load(intfc, version, stringTable)) {
            ...
            if (value.type != OverrideVariant::kType_String)
              ...
              _MESSAGE("Loaded override value %d %s", value.key,
                       value.str->c_str());
#endif
      ...
      default: {
        _MESSAGE("%s - Error loading unexpected chunk type %08X (%.4s)",
                 __FUNCTION__, type, &type);
        error = true;
        return error;
      }
...
template <>
bool ReadKey(SKSESerializationInterface* intfc, StringTableItem& key,
             UInt32 kVersion, const StringIdMap& stringTable)
{
...
template <>
void WriteKey(SKSESerializationInterface* intfc, const StringTableItem key,
              UInt32 kVersion)
{
...
template <>
void WriteKey(SKSESerializationInterface* intfc, const UInt32 key,
              UInt32 kVersion)
{
  intfc->WriteRecordData(&key, sizeof(key));
#ifdef _DEBUG
...
template <typename T>
void OverrideRegistration<T>::Save(SKSESerializationInterface* intfc,
                                   UInt32 kVersion)
{
...
template <typename T>
bool OverrideRegistration<T>::Load(SKSESerializationInterface* intfc,
                                   UInt32 kVersion,
                                   const StringIdMap& stringTable)
{
  UInt32 type, length, version;
...
// AddonRegistration
void AddonRegistration::Save(SKSESerializationInterface* intfc,
                             UInt32 kVersion)
{
...
bool AddonRegistration::Load(SKSESerializationInterface* intfc,
                             UInt32 kVersion, const StringIdMap& stringTable)
{
  UInt32 type, length, version;
  bool error = false;
      ...
      switch (type) {
        case 'AAEN': {
          ...
          if (overrideRegistration.Load(intfc, version, stringTable)) {
            _MESSAGE("%s - Error loading ArmorAddon override registrations",
                     __FUNCTION__);
            error = true;
            return error;
          }
...
// ArmorRegistration
void ArmorRegistration::Save(SKSESerializationInterface* intfc,
                             UInt32 kVersion)
{
  UInt32 numRegs = this->size();
  intfc->WriteRecordData(&numRegs, sizeof(numRegs));
...
bool ArmorRegistration::Load(SKSESerializationInterface* intfc,
                             UInt32 kVersion, const StringIdMap& stringTable)
{
  UInt32 type, length, version;
  bool error = false;
    ...
    switch (type) {
      case 'AREN': {
        ...
        if (addonRegistration.Load(intfc, version, stringTable)) {
          _MESSAGE("%s - Error loading ArmorAddon registrations",
                   __FUNCTION__);
          error = true;
          return error;
        }
...
// WeaponRegistration
void WeaponRegistration::Save(SKSESerializationInterface* intfc,
                              UInt32 kVersion)
{
  UInt32 numRegs = this->size();
  intfc->WriteRecordData(&numRegs, sizeof(numRegs));
...
bool WeaponRegistration::Load(SKSESerializationInterface* intfc,
                              UInt32 kVersion, const StringIdMap& stringTable)
{
  UInt32 type, length, version;
  bool error = false;
    ...
    if (intfc->GetNextRecordInfo(&type, &version, &length)) {
      switch (type) {
        case 'WAEN': {
          ...
          OverrideRegistration<StringTableItem> overrideRegistration;
          if (overrideRegistration.Load(intfc, version, stringTable)) {
            _MESSAGE("%s - Error loading Weapon override registrations",
                     __FUNCTION__);
            error = true;
            return error;
          }
          ...
          emplace(newHandle, overrideRegistration);
#ifdef _DEBUG
          _MESSAGE("%s - Loaded Weapon Handle %016llX", __FUNCTION__,
                   newHandle);
#endif
          break;
        }
...
bool NodeRegistrationMapHolder::Load(SKSESerializationInterface* intfc,
                                     UInt32 kVersion, UInt64* outHandle,
                                     const StringIdMap& stringTable)
{
  bool error = false;
...
void NodeRegistrationMapHolder::Save(SKSESerializationInterface* intfc,
                                     UInt32 kVersion)
{
...
void ActorRegistrationMapHolder::Save(SKSESerializationInterface* intfc,
                                      UInt32 kVersion)
{
  for (auto it = m_data.begin(); it != m_data.end(); ++it) {
...
bool ActorRegistrationMapHolder::Load(SKSESerializationInterface* intfc,
                                      UInt32 kVersion, UInt64* outHandle,
                                      const StringIdMap& stringTable)
{
  bool error = false;
...
void WeaponRegistrationMapHolder::Save(SKSESerializationInterface* intfc,
                                       UInt32 kVersion)
{
  for (auto it = m_data.begin(); it != m_data.end(); ++it) {
...
bool WeaponRegistrationMapHolder::Load(SKSESerializationInterface* intfc,
                                       UInt32 kVersion, UInt64* outHandle,
                                       const StringIdMap& stringTable)
{
  bool error = false;
...
void SkinRegistrationMapHolder::Save(SKSESerializationInterface* intfc,
                                     UInt32 kVersion)
{
  for (auto it = m_data.begin(); it != m_data.end(); ++it) {
...
bool SkinRegistrationMapHolder::Load(SKSESerializationInterface* intfc,
                                     UInt32 kVersion, UInt64* outHandle,
                                     const StringIdMap& stringTable)
{
  bool error = false;
...
// ActorRegistration
void OverrideInterface::Save(SKSESerializationInterface* intfc,
                             UInt32 kVersion)
{
...
bool OverrideInterface::LoadWeaponOverrides(SKSESerializationInterface* intfc,
                                            UInt32 kVersion,
                                            const StringIdMap& stringTable)
{
#ifdef _DEBUG
...
bool OverrideInterface::LoadOverrides(SKSESerializationInterface* intfc,
                                      UInt32 kVersion,
                                      const StringIdMap& stringTable)
{
#ifdef _DEBUG
...
bool OverrideInterface::LoadNodeOverrides(SKSESerializationInterface* intfc,
                                          UInt32 kVersion,
                                          const StringIdMap& stringTable)
{
#ifdef _DEBUG
...
bool OverrideInterface::LoadSkinOverrides(SKSESerializationInterface* intfc,
                                          UInt32 kVersion,
                                          const StringIdMap& stringTable)
{
#ifdef _DEBUG
...
void OverrideInterface::DumpMap()
{
  ...
  for (ActorRegistrationMapHolder::RegMap::iterator it =
         armorData.m_data.begin();
       it != armorData.m_data.end(); ++it) {
    for (UInt8 gender = 0; gender < 2; gender++) {
      _MESSAGE("Actor Handle: %016llX children %d", it->first,
               it->second[gender].size());
      for (ArmorRegistration::iterator ait = it->second[gender].begin();
           ait != it->second[gender].end(); ++ait) // Loop Armors
      {
        _MESSAGE("Armor Handle: %016llX children %d", ait->first,
                 ait->second.size());
        for (AddonRegistration::iterator dit = ait->second.begin();
             dit != ait->second.end(); ++dit) // Loop Addons
        {
          _MESSAGE("Addon Handle: %016llX children %d", dit->first,
                   dit->second.size());
          for (auto nit = dit->second.begin(); nit != dit->second.end();
               ++nit) // Loop Overrides
          {
            _MESSAGE("Override Node: %s children %d", nit->first->c_str(),
                     nit->second.size());
            for (OverrideSet::iterator iter = nit->second.begin();
                 iter != nit->second.end(); ++iter) {
              switch ((*iter).type) {
                case OverrideVariant::kType_String:
                  _MESSAGE("Override: Key %d Value %s", (*iter).key,
                           (*iter).str->c_str());
                  break;
                case OverrideVariant::kType_Float:
                  _MESSAGE("Override: Key %d Value %f", (*iter).key,
                           (*iter).data.f);
                  break;
                default:
                  _MESSAGE("Override: Key %d Value %X", (*iter).key,
                           (*iter).data.u);
                  break;
              }
            }
  ...
  for (NodeRegistrationMapHolder::RegMap::iterator nit =
         nodeData.m_data.begin();
       nit != nodeData.m_data.end(); ++nit) {
    for (UInt8 gender = 0; gender < 2; gender++) {
      _MESSAGE("Node Handle: %016llX children %d", nit->first,
               nit->second[gender].size());
      for (auto oit = nit->second[gender].begin();
           oit != nit->second[gender].end(); ++oit) // Loop Overrides
      {
        _MESSAGE("Override Node: %s children %d", oit->first->c_str(),
                 oit->second.size());
        for (OverrideSet::iterator iter = oit->second.begin();
             iter != oit->second.end(); ++iter) {
          switch ((*iter).type) {
            case OverrideVariant::kType_String:
              _MESSAGE("Override: Key %d Value %s", (*iter).key,
                       (*iter).str->c_str());
...
void OverrideInterface::OnAttach(TESObjectREFR* refr, TESObjectARMO* armor,
                                 ...
                                 NiNode* root)
{
  ...
  ApplySkinOverrides(refr, isFirstPerson, armor, addon, armorMask & addonMask,
                     object, g_immediateArmor);
}
