...
public:
  ...
  bool operator<(const OverrideVariant& rhs) const
  {
    return key < rhs.key || (key == rhs.key && index < rhs.index);
  }
  bool operator==(const OverrideVariant& rhs) const
  {
  ...
  void SetString(UInt16 paramKey, SInt8 controllerIndex,
                 SKEEFixedString string)
  {
    key = paramKey;
    type = kType_String;
    index = controllerIndex;
  ...
  void SetColor(UInt16 paramKey, SInt8 controllerIndex, NiColor color)
  {
    ...
    type = kType_Int;
    index = controllerIndex;
    data.u = (UInt8)(color.r * 255) << 16 | (UInt8)(color.g * 255) << 8 |
      (UInt8)(color.b * 255);
    str = nullptr;
  }
  ...
  void SetColorA(UInt16 paramKey, SInt8 controllerIndex, NiColorA color)
  {
    ...
    type = kType_Int;
    index = controllerIndex;
    data.u = (UInt8)(color.a * 255) << 24 | (UInt8)(color.r * 255) << 16 |
      (UInt8)(color.g * 255) << 8 | (UInt8)(color.b * 255);
    str = nullptr;
  }
...
template <>
void UnpackValue<float>(float* dst, OverrideVariant* src);
template <>
void UnpackValue<UInt32>(UInt32* dst, OverrideVariant* src);
template <>
void UnpackValue<SInt32>(SInt32* dst, OverrideVariant* src);
template <>
void UnpackValue<bool>(bool* dst, OverrideVariant* src);
template <>
void UnpackValue<SKEEFixedString>(SKEEFixedString* dst, OverrideVariant* src);
template <>
void UnpackValue<BSFixedString>(BSFixedString* dst, OverrideVariant* src);
template <>
void UnpackValue<NiColor>(NiColor* dst, OverrideVariant* src);
template <>
void UnpackValue<NiColorA>(NiColorA* dst, OverrideVariant* src);
template <>
void UnpackValue<BGSTextureSet*>(BGSTextureSet** dst, OverrideVariant* src);

template <typename T>
void PackValue(OverrideVariant* dst, UInt16 key, UInt8 index, T* src);

template <>
void PackValue<float>(OverrideVariant* dst, UInt16 key, UInt8 index,
                      float* src);
template <>
void PackValue<UInt32>(OverrideVariant* dst, UInt16 key, UInt8 index,
                       UInt32* src);
template <>
void PackValue<SInt32>(OverrideVariant* dst, UInt16 key, UInt8 index,
                       SInt32* src);
template <>
void PackValue<bool>(OverrideVariant* dst, UInt16 key, UInt8 index, bool* src);
template <>
void PackValue<SKEEFixedString>(OverrideVariant* dst, UInt16 key, UInt8 index,
                                SKEEFixedString* src);
template <>
void PackValue<BSFixedString>(OverrideVariant* dst, UInt16 key, UInt8 index,
                              BSFixedString* src);
template <>
void PackValue<NiColor>(OverrideVariant* dst, UInt16 key, UInt8 index,
                        NiColor* src);
template <>
void PackValue<NiColorA>(OverrideVariant* dst, UInt16 key, UInt8 index,
                         NiColorA* src);
template <>
void PackValue<BGSTextureSet*>(OverrideVariant* dst, UInt16 key, UInt8 index,
                               BGSTextureSet** src);